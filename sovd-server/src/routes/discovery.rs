        ...
        web::scope("/components")
            ...
            .service(
                web::scope("/{id}")
                    ...
                    // Data routes - delegated to data module
                    .route("/data", web::get().to(super::data::list_data_resources))
                    .route("/data/{data_id}", web::get().to(super::data::get_data_value))
                    .route("/data/{data_id}", web::put().to(super::data::set_data_value))
                    .route("/data-categories", web::get().to(super::data::list_data_categories))
                    .route("/data-groups", web::get().to(super::data::list_data_groups)),
            ),
    );
}
