...
[![CI](https://github.com/lh-sag/sovd-playground/actions/workflows/ci.yaml/badge.svg?event=push&branch=main)](https://github.com/lh-sag/sovd-playground/actions/workflows/ci.yaml?query=event%3Apush+branch%3Amain)
